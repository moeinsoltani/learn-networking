...
```
   ...
   trapline (Cree, Ojibwe,        Indigenous trappers & traders
   Dene country)                   — the PRODUCTION layer
        │  furs move by canoe/to posts
        ▼
   ...
   or York Factory ──► London      voyageurs & ships
        │
        ▼
   felt-makers & hatters           Europe's fashion industry
```
...
The competition mapped the West: NWC explorers seeking routes and customers —
**Alexander Mackenzie** (to the Arctic 1789, to the Pacific 1793 — beating
...
the competition. Standard trade protocols were Indigenous ones — trade
opened with the pipe, speeches, and gifts, because in most Indigenous
economies **exchange rode on relationship**: no kinship, no trade. Which
leads to...
...
Their descendants — French/Cree, Scots/Ojibwe and more — coalesced into a
**new people**: the **Métis Nation**, centred on the Red River (today's
Winnipeg), with its own language (**Michif**: French nouns, Cree verbs — a
linguistic marvel), its own economy (the bison-hunt brigades provisioning
the trade with pemmican), its flag (the infinity symbol, flown from 1816),
...
> The Hudson's Bay Company, chartered 1670, sold Rupert's Land to Canada in
> 1870 (Lesson 14) and gradually became... a retail chain — "The Bay,"
> anchoring malls across the country until its final bankruptcy wound down
> the stores in 2025. For 355 years, its striped point blankets — once
> standard fur-trade goods — remained the brand. History note when you see
> one: those blankets were trade currency on a continent-sized commercial
...
| North West Company | <https://en.wikipedia.org/wiki/North_West_Company> |
| Voyageurs | <https://en.wikipedia.org/wiki/Voyageurs> |
| Michif language | <https://en.wikipedia.org/wiki/Michif> |
| Alexander Mackenzie | <https://en.wikipedia.org/wiki/Alexander_Mackenzie_(explorer)> |

---

## Checkpoint

**Q1.** *(citizenship-style)* What was the Hudson's Bay Company, when was it
founded, and what was Rupert's Land?
...
<br>
A fur-trading company chartered by King Charles II in 1670 — for centuries
the dominant commercial power in the Canadian Northwest, and Canada's oldest
corporation (surviving as a retailer into the 2020s). Rupert's Land was its
chartered monopoly territory: the entire Hudson Bay drainage basin, about a
third of modern Canada, "owned" on paper from 1670 until the company sold it
to the new Dominion of Canada in 1870 — a sale whose overlooked inhabitants
(Métis and First Nations) immediately made their objections felt (Lessons 15
and 17).
</details>

**Q2.** Why do historians insist the fur trade was a *partnership*, and
what three roles (beyond trapping) did Indigenous people and nations play in
it?
...
<summary>Show Answer</summary>
<br>
Because every layer of the enterprise ran on Indigenous capacity and
consent: Europeans couldn't reach, survive, or navigate the interior alone,
and trade happened under Indigenous protocols (gifts, pipe, kinship) at
prices Indigenous customers comparison-shopped between rival companies.
Roles beyond trapping (any three): <strong>middlemen</strong> — nations like
the Cree and Assiniboine controlled access and resold inland furs at margin;
<strong>provisioners</strong> — the bison-hunting economy (pemmican) fed the
canoe brigades; <strong>guides and geographers</strong> — every "explorer's"
route ran on Indigenous knowledge; <strong>diplomatic powers</strong> —
alliances determined which empire's trade prospered; and
<strong>wives/kin</strong> — the marriages à la façon du pays that made
trade relationships durable and produced the Métis Nation.
</details>

**Q3.** Who are the Métis, and what evidence — political, economic,
linguistic — supports calling them a distinct *nation* rather than simply
...
<summary>Show Answer</summary>
<br>
The Métis are the people who emerged from fur-trade intermarriage
(French/Scottish traders and First Nations — largely Cree, Ojibwe,
Saulteaux — women), centred historically on the Red River and the Prairie
West, and recognized in Section 35 of the Constitution as one of Canada's
three Indigenous peoples. Nation evidence: <em>linguistic</em> — Michif, a
full mixed language only a stable bilingual community could produce;
<em>economic</em> — a distinct collective economy (the disciplined bison-hunt
brigades with their own laws of the hunt, the pemmican provisioning trade,
the Red River cart networks); <em>political</em> — collective action under
their own flag from 1816 (Battle of Seven Oaks), provisional governments in
1869 and 1885 (Lesson 15), and continuous political organizations to today's
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Lesson 10 — The Conquest and Its Bargain →](lesson-10-conquest-1763){: .btn .btn-primary }
