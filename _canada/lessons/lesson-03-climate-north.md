---
title: "Lesson 03 — Climate and the North"
nav_order: 3
...
- **Pacific coast (Vancouver, Victoria):** the mildest climate in Canada —
  warm ocean currents mean wet, green winters that rarely freeze. This is why
...
3. **Sea ice** — for Inuit communities, sea ice is winter *highway and hunting
...
| Topic | Source |
|---|---|
| Climate of Canada | <https://en.wikipedia.org/wiki/Climate_of_Canada> |
| Permafrost | <https://en.wikipedia.org/wiki/Permafrost> |
| Northwest Passage (incl. the dispute) | <https://en.wikipedia.org/wiki/Northwest_Passage> |
| Canadian Rangers | <https://en.wikipedia.org/wiki/Canadian_Rangers> |
| Territorial evolution & "North of 60" | <https://www.thecanadianencyclopedia.ca/> |

---

## Checkpoint

**Q1.** Why is Victoria, BC milder in winter than St. John's, NL, and why is
Winnipeg colder than both despite being *south* of St. John's?
...
<br>
Oceans moderate temperature; continental interiors don't. Victoria sits on the
Pacific with warm ocean influence, giving Canada's mildest winters.
St. John's is oceanic too (so milder than its latitude suggests) but sits
where the cold Labrador Current meets the warm Gulf Stream — moderated, yet
stormy, foggy, and snowy. Winnipeg is a thousand-plus kilometres from any
ocean, so nothing buffers the Arctic air masses that pour south in winter —
hence January means around −16°C. Rule: distance from the sea beats latitude.
</details>

**Q2.** Define treeline and permafrost, and give one concrete way each shapes
human life in the North.
...
<summary>Show Answer</summary>
<br>
The <strong>treeline</strong> is the northern limit beyond which trees can't
grow — the boundary between boreal forest and tundra; north of it there's no
local timber or fuelwood, and historically it marked the rough divide between
First Nations (forest) and Inuit (tundra/coast) homelands. <strong>Permafrost</strong>
is ground that stays frozen year-round; buildings must stand on piles to avoid
melting it, buried pipes are often impossible, and its accelerating thaw is
cracking foundations, roads, and runways across the territories — making
climate change a present infrastructure emergency there rather than a distant
worry.
</details>

**Q3.** *(citizenship-style)* What is the Northwest Passage, and what does
Canada claim about it that the United States disputes?
...
<summary>Show Answer</summary>
<br>
The sea route through Canada's Arctic islands connecting the Atlantic and
Pacific — sought by explorers for centuries (Franklin's lost expedition being
the most famous casualty) and increasingly navigable as sea ice retreats.
Canada claims the Passage's waters as <em>internal Canadian waters</em>, over
which it has full control; the US (and others) consider it an
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Lesson 4 — Where the People Are →](lesson-04-where-people-are){: .btn .btn-primary }
