---
title: "Lesson 07 — European Contact"
nav_order: 7
...
It matters mostly as a corrective: Europeans "reaching America first" was
never the important question; *sustained contact* was, and that begins in the
1490s.

### Cabot and the cod century

John Cabot's 1497 voyage from Bristol (he was Venetian — European exploration
was a freelance business) hit Newfoundland and reported seas so thick with
cod you could scoop them in baskets. What followed was a century with almost
no colonists but *thousands* of European fishermen — English, French,
Portuguese, Basque — summering on the coasts, drying fish, and increasingly
trading metal goods with Indigenous people for furs on the side. Two futures
were born on those beaches: the Atlantic fishery (Lesson 05's oldest staple)
and the fur trade (Lesson 09) — which started as the cod fishery's side
hustle. The Basque whaling station at Red Bay, Labrador, and Mi'kmaq sailors
in European shallops within a couple of generations show how fast the coast
became a working *contact zone* rather than a frontier.

### Cartier: the name, the river, the pattern

Jacques Cartier's three voyages (1534, 1535–36, 1541–42) for France:

- **1534:** explored the Gulf, planted a 30-foot cross at Gaspé claiming the
  land for France — while Donnacona, the Iroquoian chief watching, objected
  through signs that the land was his. Cartier took two of Donnacona's sons
  to France (initially by trickery) — beginning the pattern of Indigenous
  people as involuntary intermediaries.
...
Hochelaga were **gone** — the St. Lawrence Iroquoians had vanished as a
people (war, disease, dispersal; historians still debate the mix). The
...
work no European army could have.

{: .note }
> **Why "discovery" is the wrong word**
> Not (only) as a courtesy: it's analytically wrong. Discovery implies
> finding something unknown and unowned. Every coast was known, named,
> owned, and defended; what happened in 1497–1608 was <em>contact</em>
> between civilizations, followed by <em>invasion and colonization</em> —
> processes with dates, treaties, and laws you can study, which "discovery"
...
| Name of Canada ("kanata") | <https://en.wikipedia.org/wiki/Name_of_Canada> |
| Columbian exchange | <https://en.wikipedia.org/wiki/Columbian_exchange> |
| St. Lawrence Iroquoians | <https://en.wikipedia.org/wiki/St._Lawrence_Iroquoians> |

---

## Checkpoint

**Q1.** *(citizenship-style)* Where does the name "Canada" come from?
...
<br>
From <em>kanata</em>, the St. Lawrence Iroquoian word for "village" or
"settlement." In 1535, guides directing Jacques Cartier used it for the
area around Stadacona (present-day Quebec City); Cartier wrote it down as
the name of the wider country, and the label stuck — spreading on maps until
it covered half a continent. A country named, in effect, by a
misunderstanding of the word for "the village."
</details>

**Q2.** What did each of these bring or begin: Cabot's 1497 voyage, the
Basque and other fishermen of the 1500s, Cartier's voyages?
...
<summary>Show Answer</summary>
<br>
Cabot: England's claim in the New World and the discovery of the Grand Banks
cod — the staple that made "Canada" economically interesting to Europe for a
century before anyone settled. The 1500s fishing fleets: sustained seasonal
contact — drying stations, whaling posts (Red Bay), and the first regular
fur-for-metal trade with Indigenous peoples, i.e. the fur trade's embryo.
Cartier: France's claim, the route up the St. Lawrence, the name "Canada,"
the first (failed) colonization attempt — and the template of dependence on
Indigenous knowledge (the scurvy cure) alongside betrayal of it (kidnapping
Donnacona's sons, and eventually Donnacona himself, who died in France).
</details>

**Q3.** Why do historians say disease, not military power, was the decisive
force of early colonization in North America?
...
<summary>Show Answer</summary>
<br>
Because the demographic collapse came first and cut deepest: Old World
pathogens — smallpox above all — spread along Indigenous trade routes ahead
of European settlement, killing in many regions a majority of the population
(estimates often exceed 90% over the first centuries), emptying towns like
those Cartier saw (Stadacona and Hochelaga were gone within 70 years), and
shattering the political and military capacity of nations that would
otherwise have dwarfed the tiny European footholds (Quebec in 1608: 28 men;
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Lesson 8 — New France →](lesson-08-new-france){: .btn .btn-primary }
