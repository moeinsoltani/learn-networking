...
you referendums and language laws, this lesson is where the story starts.
...
Champlain's Quebec (1608) survived its first winter with 8 of 28 men alive —
and survived at all only by entering the existing political system: the
French allied with the **Wendat (Huron)**, **Innu**, and **Algonquin**, who
controlled the fur routes — and that alliance's price was joining their wars
against the **Haudenosaunee** (Champlain personally shooting Mohawk chiefs
in 1609). Consequences: 150 years of intermittent French–Haudenosaunee war,
and a fur-trade partnership so structural that the French crown's colony was,
in practice, junior partner in an Indigenous alliance network. The **Great
Peace of Montreal (1701)** — signed by France and ~39 nations including the
Haudenosaunee — ended the wars and stands as one of the great diplomatic
achievements on Canadian soil.

### The society of the ribbon
...
- **The Catholic Church:** ran education, hospitals, and charity; parishes
  structured social life; missionary orders (Jesuits, Ursulines) pushed into
  Indigenous country. The Church's grip on French-Canadian society, forged
  here, lasts until the Quiet Revolution — *1960* (Lesson 22).
- **The Filles du Roi:** ~800 young women recruited and dowered by Louis XIV
...
- **Coureurs des bois and voyageurs:** the young men who went into the
  interior to trade — illegally at first, then as licensed canoe labour.
...
| Topic | Source |
|---|---|
| New France (overview) | <https://en.wikipedia.org/wiki/New_France> |
| Samuel de Champlain | <https://en.wikipedia.org/wiki/Samuel_de_Champlain> |
| Seigneurial system | <https://en.wikipedia.org/wiki/Seigneurial_system_of_New_France> |
| Filles du Roi | <https://en.wikipedia.org/wiki/King%27s_Daughters> |
| Great Peace of Montreal (1701) | <https://en.wikipedia.org/wiki/Great_Peace_of_Montreal> |
...
**Q1.** *(citizenship-style)* Who founded Quebec City and when, and what
were the three main settlements of New France?
...
<br>
Samuel de Champlain, 1608 — "the Father of New France." The three
St. Lawrence towns: Quebec (1608), Trois-Rivières (1634), and Montreal
(founded 1642 as Ville-Marie, a missionary venture). All three are still
there, which makes Quebec City home to the oldest continuous European urban
settlement in Canada — its walled Old Town is a UNESCO site.
</details>

**Q2.** Explain the seigneurial system and the role of the Catholic Church
in New France — and name the modern trace each has left.
...
<summary>Show Answer</summary>
<br>
The seigneurial system: Crown land granted to seigneurs in long riverfront
strips, subdivided to habitant families who farmed with personal freedom and
light fixed dues — producing a rooted, parish-centred rural society. Modern
trace: the long-lot field pattern still visible across Quebec (and place
names — every "Saint-…-de-…" village). The Church ran education, hospitals,
and social life, and after the Conquest became the guardian institution of
French-Canadian identity. Modern trace: its dominance lasted until the Quiet
Revolution of the 1960s, and today's Quebec — the most secular province,
with crosses on mountaintops and a fierce laïcité politics — is best read as
a post-religious society still arguing with that inheritance (Lessons 22,
43).
</details>

**Q3.** Who were the Acadians, what happened in 1755, and what two modern
facts descend from it?
...
<summary>Show Answer</summary>
<br>
French settlers of Acadia (the Bay of Fundy region, from 1604) — a distinct
community of marshland farmers, Mi'kmaq allies, and would-be neutrals
between empires. In 1755–63 the British deported around 10,000 of them
(le Grand Dérangement), burning villages and scattering families through the
Thirteen Colonies, Britain, France — and Louisiana. Two modern descendants:
the Cajuns of Louisiana ("Cajun" is "Acadian" worn smooth), and the Acadian
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Lesson 9 — The Fur Trade →](lesson-09-fur-trade){: .btn .btn-primary }
