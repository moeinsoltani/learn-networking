---
title: "Lesson 13 — Confederation, 1867"
nav_order: 13
...
resistance. Canada, characteristically, was founded as *the sensible
option*.
...
- **Charlottetown, September 1864.** The Maritimes met to discuss
  *their own* union; the Canadians invited themselves (arriving by
  steamer with $13,000 of champagne — genuinely), pitched the bigger
  idea, and hijacked the agenda. PEI's contribution: hosting a
...
Of the ~36 **Fathers of Confederation**, carry four:

- **John A. Macdonald** (Kingston lawyer, Conservative): the drafter and
  dealmaker; first Prime Minister; knighted July 1, 1867. Brilliant,
  alcoholic, ruthless — architect of both the country and (Lessons
  14–17) its darkest policies. Modern Canada argues about his statues;
  this course will give you the material to argue well.
- **George-Étienne Cartier** (Montreal, leader of the *bleus*): the
  co-founder. No Cartier, no Quebec; no Quebec, no Canada. He sold
  federation to French Canada as *the escape from* Durham's union — a
  province of their own, with their law, language, and Church secured.
  The Macdonald–Cartier partnership is Baldwin–LaFontaine's direct heir.
- **George Brown** (Toronto *Globe* publisher, Reform/Liberal leader):
  Macdonald's bitterest enemy, who in 1864 crossed the floor to form the
  **Great Coalition** with him because the deadlock mattered more than
  the feud — the act of political self-sacrifice that unlocked
  everything.
- **Charles Tupper / Samuel Leonard Tilley** (premiers of NS and NB):
  who dragged their reluctant provinces in — Tilley is credited with
  proposing "**Dominion**" (from Psalm 72: "He shall have dominion also
  from sea to sea" — the motto's source, Lesson 01).

### The deal: what the BNA Act built

- **A federation** — the core compromise. Macdonald wanted one big
  unitary government ("legislative union"); Quebec and the Maritimes
  would never accept erasure. Result: two levels, each sovereign in its
  own list — **s.91** federal powers (trade, defence, criminal law,
  banking, "Indians and Lands reserved for the Indians"...), **s.92**
  provincial (property and civil rights, education, health...,) —
...
- **Minority guarantees**: s.133 — French *and* English in the federal
  ...
  denominational (Catholic/Protestant) school rights. Small clauses,
  vast descendants (Lesson 42).
- **The famous phrase**: federal power to make laws for the "**Peace,
  Order, and good Government of Canada**" — POGG, Canada's counter-motto
  to "life, liberty, and the pursuit of happiness" (Lesson 11's contrast,
  now in statute).
- **The promise attached**: an Intercolonial Railway to the Maritimes —
  written *into the constitution* (s.145). Nation-building as
  infrastructure clause: next lesson.

**What Confederation was not:** independence (Britain kept foreign
affairs, the constitution itself, and final appeal courts for decades);
universal — **Nova Scotia promptly elected 18 of 19 MPs on a
secessionist platform** in 1867 (Joseph Howe led the "Antis"; bought off
with better terms in 1869 — the first of many); and it was negotiated
with **no Indigenous participation whatsoever**, while s.91(24) quietly
...
| Constitution Act, 1867 | <https://en.wikipedia.org/wiki/Constitution_Act,_1867> |
| John A. Macdonald | <https://en.wikipedia.org/wiki/John_A._Macdonald> |
| George-Étienne Cartier | <https://en.wikipedia.org/wiki/George-%C3%89tienne_Cartier> |
| Charlottetown Conference | <https://en.wikipedia.org/wiki/Charlottetown_Conference> |
| Fathers of Confederation | <https://www.thecanadianencyclopedia.ca/> |

---

## Checkpoint

**Q1.** *(citizenship-style)* When and how did Confederation happen, which
provinces founded it, and who was the first Prime Minister?
...
<br>
July 1, 1867, when the British North America Act — negotiated by colonial
delegates at the Charlottetown (1864), Quebec (1864), and London
(1866–67) conferences and passed by the British Parliament — united
Ontario, Quebec, Nova Scotia, and New Brunswick as the Dominion of
Canada. Sir John A. Macdonald became the first Prime Minister. July 1 is
now Canada Day.
</details>

**Q2.** Name the three pressures that drove Confederation, and for each,
the specific 1860s event or condition behind it.
...
<summary>Show Answer</summary>
<br>
(1) Political deadlock: the Province of Canada's equal English–French
halves made stable government impossible — four ministries fell in
1861–64, driving even enemies (Brown joining Macdonald and Cartier's
Great Coalition, 1864) to seek federation as divorce-with-partnership.
(2) The American threat: the Civil War's end left a giant battle-tested
army and annexationist sentiment; Fenian raids (Irish-American veterans
attacking across the border, 1866) made it tangible; U.S. cancellation
of the Reciprocity Treaty (1866) added economic coercion. (3) Railways
and finance: colonies over-indebted from railway building needed a
common market, shared credit, and the Intercolonial Railway — which
Confederation wrote into the constitution itself (s.145), with London's
banks lobbying hard. Britain's desire to shed defence costs greased all
three.
</details>

**Q3.** Why is it accurate to say Canada was founded as a federation
*because of* Quebec — and what did each side of the Macdonald–Cartier
bargain give up?
...
<summary>Show Answer</summary>
<br>
Macdonald openly preferred a unitary state ("legislative union") — one
parliament, no provinces — which he considered cheaper and stronger. That
design was impossible because French Canada (and the Maritimes) would
never enter a state where an anglophone majority controlled their civil
law, schools, and church; Cartier's price for Quebec was a province with
real sovereignty over those things. So Macdonald gave up his unitary
dream (settling for what he expected — wrongly — to be a centralized
federation with provinces as glorified municipalities); Cartier gave up
the safety of the status quo and gambled that written guarantees (ss. 93,
133, the civil law, 65 fixed seats) inside a new "political nationality"
would protect his people better than isolation. Federalism — Canada's
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Lesson 14 — The Railway and the West →](lesson-14-railway-west){: .btn .btn-primary }
