---
title: "Lesson 14 — The Railway and the West"
nav_order: 14
...
it claimed land to three oceans; within **eighteen**, a steel rail ran from
Montreal to the Pacific. This lesson is the story of the most audacious —
...
against American railways pulling trade south, and to move troops (it did,
in 1885 — against the Métis, Lesson 15). "National Dream" and instrument
of dispossession, in one artifact.
...
### BC's bargain and the impossible promise

British Columbia — gold-rush colony, 36,000 people, heavily in debt,
flirting with American annexation — named its price for joining
Confederation: a **transcontinental railway, begun in two years, finished
in ten**. Macdonald agreed to build ~3,000 km of track through Shield
muskeg and four mountain ranges, for a country of 3.5 million. Critics
...
- **The CPR syndicate (1881–85):** a new private company (Stephen, Smith,
  ...
  **Last Spike** went in at Craigellachie, BC, November 7, 1885. The
  famous photo — grey-bearded Donald Smith hammering — contains, note
  well, no politicians and none of the men who did the dangerous work.

### The men the photo omits

Through the Fraser Canyon and the mountains, the CPR ran on **~15,000
Chinese labourers**, recruited mainly from Guangdong, paid roughly
$1/day — half or less of white workers' wages — and assigned the
explosives, the tunnels, the ledges. Estimates of the dead run from
...
economic grievance: sell at world prices, buy at protected ones — file
...
> 1905 — but Ottawa kept control of their **Crown lands and natural
> resources until 1930**, unlike the founding provinces. The West entered
> Confederation, in its own reading, as a colony of the East: settled on
...
| Topic | Source |
|---|---|
| Canadian Pacific Railway | <https://en.wikipedia.org/wiki/Canadian_Pacific_Railway> |
| Pacific Scandal | <https://en.wikipedia.org/wiki/Pacific_Scandal> |
| Chinese head tax | <https://en.wikipedia.org/wiki/Chinese_head_tax_in_Canada> |
| National Policy | <https://en.wikipedia.org/wiki/National_Policy> |
| North-West Mounted Police | <https://en.wikipedia.org/wiki/North-West_Mounted_Police> |
| The Last Spike | <https://www.thecanadianencyclopedia.ca/> |

---

## Checkpoint

**Q1.** *(citizenship-style)* Why did British Columbia join Confederation
in 1871, and what event on November 7, 1885 fulfilled the condition?
...
<br>
BC joined on Canada's promise of a transcontinental railway (begun within
two years, completed within ten) — the alternative being drift toward
American annexation. The condition was fulfilled — late, but fulfilled —
when the Canadian Pacific Railway's Last Spike was driven at
Craigellachie, British Columbia, on November 7, 1885, completing the line
from Montreal to the Pacific.
</details>

**Q2.** What was the Pacific Scandal, and what three-part program did
Macdonald campaign on when he returned to power in 1878?
...
<summary>Show Answer</summary>
<br>
The Pacific Scandal (1873): revelations that the original CPR charter
went to Sir Hugh Allan's syndicate after Allan secretly financed
Macdonald's 1872 re-election campaign (~$350,000, including Macdonald's
telegraphed "I must have another ten thousand"). The government resigned
— Canada's first great political scandal. Macdonald returned in 1878 with
the National Policy: (1) high protective tariffs to build Canadian
manufacturing; (2) completion of the transcontinental railway; (3) mass
immigration to settle the West. The triad defined Canadian economic
strategy for two generations — and its regional asymmetries (the West
paying tariff prices while selling at world prices) seeded Western
alienation.
</details>

**Q3.** Give the honest two-sided summary of the CPR — the case for
"National Dream" and the ledger of its costs, with specifics on both
sides.
...
<summary>Show Answer</summary>
<br>
Dream side: it made the country physically real — bound BC in, enabled
the settlement of the Prairies (Lesson 16), created the east–west economy
and half the western cities, and stands as a genuine engineering feat
(the Shield's muskeg swallowed whole trains; the mountain passes were
thought impassable). Cost ledger: built partly by ~15,000 underpaid
Chinese labourers doing the deadliest work, hundreds of whom died —
answered with the Head Tax the same year it opened; financed with 25
million acres of land whose Indigenous inhabitants were being confined
to reserves through the numbered treaties and, when the buffalo
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Lesson 15 — Riel and the Métis Resistances →](lesson-15-riel-metis){: .btn .btn-primary }
