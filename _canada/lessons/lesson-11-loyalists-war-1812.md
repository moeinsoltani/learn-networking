---
title: "Lesson 11 — Loyalists and the War of 1812"
nav_order: 11
...
supplied the people: tens of thousands of refugees who had picked the losing
side and trekked north. The **War of 1812** supplied the story: the invasion
...
by the people who said no. Political scientists trace real cultural
consequences from this: Canada's greater deference to institutions, "peace,
order and good government" (you'll meet the phrase officially in Lesson 13)
versus "life, liberty and the pursuit of happiness." Founding populations
set trajectories — Lesson 08's founder-effect logic, now on the English
side.
...
- **~35,000 to Nova Scotia** — so many that the colony split: **New
  Brunswick was created for them in 1784**. Among them ~3,000 **Black
  Loyalists**, promised freedom and land for service — they received the
  worst land, latest (Birchtown; and in 1792, ~1,200 gave up on Nova Scotia
  and sailed to found Freetown, Sierra Leone — an Atlantic-history detail
  every Canadian should know).
- **~10,000 up the St. Lawrence and Niagara** — the founding population of
  what became Ontario.
- **~2,000 Haudenosaunee allies** under **Joseph Brant
  (Thayendanegea)** — the Mohawk had fought for the Crown and lost their
  New York homeland for it; Britain granted the **Haldimand Tract** along
  the Grand River (1784). Its unresolved boundaries are the root of the
...
powers will cause the explosions of Lesson 12.
...
The defence held — three names carry the citizenship-test load:

- **Isaac Brock**, the general who took Detroit by audacity and died
  repelling the invasion at **Queenston Heights** (October 1812);
- **Tecumseh**, the Shawnee leader whose confederacy was Britain's
  indispensable ally — the capture of Detroit was as much his as Brock's;
  he died at Moraviantown (1813), and with him died the last real hope of
  an independent Indigenous state in the Great Lakes;
- **Laura Secord**, who walked ~30 km through American lines to warn of an
  attack (Beaver Dams, 1813) — Canada's favourite war legend (the
  chocolates came later and are unrelated).

Also in the ledger: the Canadien **Voltigeurs** under Salaberry repulsed
the thrust at Châteauguay (French Canadians defending British Canada — the
Quebec Act bargain paying out); the Americans burned **York** (Toronto) in
1813; the British burned **Washington** (the White House got its
whitewash) in 1814. The **Treaty of Ghent (1814)** restored the status quo
ante — nobody "won" on paper.
...
- **Losers, decisively: the Indigenous nations.** Tecumseh's confederacy
  ...
  state) at Ghent; and with the U.S. threat managed, Britain's need for
...
| Topic | Source |
|---|---|
| United Empire Loyalists | <https://en.wikipedia.org/wiki/United_Empire_Loyalist> |
| Black Loyalists | <https://en.wikipedia.org/wiki/Black_Loyalist> |
| Constitutional Act 1791 | <https://en.wikipedia.org/wiki/Constitutional_Act_1791> |
| War of 1812 | <https://en.wikipedia.org/wiki/War_of_1812> |
| Tecumseh | <https://en.wikipedia.org/wiki/Tecumseh> |
| Laura Secord | <https://en.wikipedia.org/wiki/Laura_Secord> |

---

## Checkpoint

**Q1.** *(citizenship-style)* Who were the United Empire Loyalists, and
name two lasting marks they left on the map of Canada.
...
<br>
Colonists who remained loyal to the Crown during the American Revolution
and migrated (mostly 1783–84) to British North America — about 50,000
people, including some 3,000 Black Loyalists and ~2,000 Haudenosaunee
allies under Joseph Brant. Map marks (any two): the creation of New
Brunswick (1784) to accommodate the Nova Scotia influx; the founding
settlement of Upper Canada (Ontario) along the St. Lawrence and Niagara,
leading to the 1791 split into Upper and Lower Canada; the Haldimand Tract
grant to the Six Nations on the Grand River; and Black Loyalist communities
in Nova Scotia (Birchtown) whose later exodus founded Freetown, Sierra
Leone.
</details>

**Q2.** *(citizenship-style)* In the War of 1812, what did Brock, Tecumseh,
and Laura Secord each do — and what was the war's result?
...
<summary>Show Answer</summary>
<br>
Major-General Sir Isaac Brock organized the early defence of Upper Canada,
captured Detroit (with Tecumseh) and died repelling the American invasion
at Queenston Heights in October 1812. Tecumseh, the Shawnee leader, brought
his Indigenous confederacy into alliance with Britain — decisive at
Detroit — and died at the Battle of the Thames (Moraviantown) in 1813.
Laura Secord walked roughly 30 km through occupied territory in 1813 to
warn British and Kahnawake Mohawk forces of a planned American attack,
contributing to the victory at Beaver Dams. Result: the Treaty of Ghent
(1814) restored pre-war borders — the invasion failed, British North
America survived, and the Canada–US border was subsequently demilitarized
and has held ever since.
</details>

**Q3.** Explain the claim "the United States was born of revolution;
English Canada was born of counter-revolution" — and one lasting
political-culture difference plausibly traced to it.
...
<summary>Show Answer</summary>
<br>
The American founding population self-selected for people willing to
overthrow authority for liberty; English Canada's founding population
self-selected for the opposite — people who kept faith with Crown and
institutions at ruinous personal cost, then built a society explicitly
against the revolutionary model next door. Plausible traces (any one):
Canada's constitutional watchword "peace, order and good government"
versus "life, liberty and the pursuit of happiness"; evolution-not-
revolution as the Canadian method of independence (achieved by statutes
and conferences, 1848–1982, without a war); comparatively higher trust in
and deference to public institutions (police, courts, public
broadcasters); and the instinct that rights coexist with collective order
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Phase 3 — Confederation & Expansion →](phase-03-confederation-expansion){: .btn .btn-primary }
