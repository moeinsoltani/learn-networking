---
title: "Lesson 12 — Rebellion and Responsible Government"
nav_order: 12
...
- **Lower Canada:** the deeper crisis. **Louis-Joseph Papineau**'s Patriote
...
- **Upper Canada:** almost farce by comparison — **William Lyon
  ...
  few hundred men down Yonge Street in December 1837; scattered by one
  volley. Two leaders hanged; Mackenzie fled to the U.S.

The rebellions failed as war and succeeded as alarm bell: London, having
just lost thirteen colonies, actually *investigated*.

### Durham's Report (1839): the insult and the idea

Lord Durham — "Radical Jack" — spent five months in Canada and produced the
era's most consequential document. It contains one famous insult and two
recommendations:

- **The insult:** he found in Lower Canada *"two nations warring in the
  bosom of a single state"* and judged the French Canadians a people
  *"with no history and no literature"* — whose happy destiny was
  assimilation into English commerce.
- **Recommendation 1 — assimilation:** unite the two Canadas so the
  English would outvote the French. Done: the **Act of Union, 1840** made
  the single Province of Canada (Canada West / Canada East), with English
  the sole official language of its records (until 1848).
- **Recommendation 2 — responsible government:** let the colonial
  executive be drawn from, and answerable to, the elected assembly's
  majority — cabinet government, as in Britain. London balked, then
  yielded.

History graded the two recommendations oppositely: assimilation **failed
completely** (see below), responsible government **became the constitution**.

### Winning it without a shot (1848)

The heroes of this stage are parliamentarians, not soldiers — and the
partnership matters as much as the principle: **Robert Baldwin** (Canada
West reformer) and **Louis-Hippolyte LaFontaine** (Canada East) built a
*bilingual reform alliance* — the very cooperation Durham said was
impossible. (Symbol worth remembering: when mobs kept LaFontaine from a
seat, Baldwin's riding of York elected the francophone LaFontaine; later
Canada East returned the favour for Baldwin.) In **Nova Scotia, Joseph
Howe** won responsible government *first* — February 1848, the first in
the Empire — with Canada following weeks later under Governor **Lord
Elgin**, who accepted the reformers' ministry.
...
And Durham's assimilation? The united Province promptly developed *double
majorities*, French–English partnership ministries, and permanent deadlock
...
> the 1848 rule: command the elected chamber's confidence or resign. When
> Lesson 27 shows you a modern PM surviving or falling by a confidence
> vote, it is running unmodified 1848 software. And the *method* set the
...
| Topic | Source |
|---|---|
| Rebellions of 1837–38 | <https://en.wikipedia.org/wiki/Rebellions_of_1837%E2%80%931838> |
| Lord Durham's Report | <https://en.wikipedia.org/wiki/Report_on_the_Affairs_of_British_North_America> |
| Responsible government | <https://en.wikipedia.org/wiki/Responsible_government> |
| Baldwin & LaFontaine | <https://en.wikipedia.org/wiki/Louis-Hippolyte_Lafontaine> |
| Burning of the Parliament in Montreal | <https://en.wikipedia.org/wiki/Burning_of_the_Parliament_Buildings_in_Montreal> |

---

## Checkpoint

**Q1.** *(citizenship-style)* What is responsible government, and which
British North American colony achieved it first, led by whom?
...
<br>
The system under which the executive (premier/prime minister and cabinet)
must be drawn from and retain the confidence of the elected assembly —
losing a confidence vote means resigning or calling an election. Nova
Scotia achieved it first — February 1848, the first responsible government
in the British Empire outside Britain — through the campaign of Joseph
Howe, without a shot fired (as Howe boasted, "without a blow struck or a
pane of glass broken"). The Province of Canada followed weeks later under
the LaFontaine–Baldwin ministry, accepted by Governor Lord Elgin.
</details>

**Q2.** Who led the 1837 rebellions in each Canada, what were the elite
cliques they fought called, and what did the rebellions achieve despite
failing militarily?
...
<summary>Show Answer</summary>
<br>
Upper Canada: William Lyon Mackenzie against the <em>Family Compact</em>.
Lower Canada: Louis-Joseph Papineau's Patriotes against the <em>Château
Clique</em> — a larger, bloodier rising with a national (French vs
anglophone-executive) dimension. Both were crushed. Achievement: they
forced London to send Lord Durham, whose report — its assimilationist half
notwithstanding — recommended responsible government; the 1840 Act of
Union and the reform politics of Baldwin, LaFontaine, and Howe then
delivered it by 1848. Failed rebellion → honest inquiry → structural
reform: the sequence itself became the Canadian method.
</details>

**Q3.** Why is the Baldwin–LaFontaine partnership remembered as more than a
successful political alliance?
...
<summary>Show Answer</summary>
<br>
Because it was the living refutation of Durham's premise. Durham had
declared French and English "two nations warring" who could share no
state; within a decade an anglophone Protestant reformer and a francophone
Catholic reformer jointly led the government of the union designed to
assimilate the latter — each even elected at need by the <em>other's</em>
community (York electing LaFontaine in 1841 after violence blocked his
Terrebonne seat). They proved the alternative to both assimilation and
...
<!-- nav-next -->
[← Home]({{ '/' | relative_url }}){: .btn .btn-outline }
[Next: Lesson 13 — Confederation, 1867 →](lesson-13-confederation-1867){: .btn .btn-primary }
